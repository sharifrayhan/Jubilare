...
const PricingCards = ({ card }) => {
  ...
  return (
    <div>
      <center className="text-white font-bold text-xl my-2">
        <h1>{title}</h1>
      </center>
      <div className=" w-80 lg:w-full glass flex flex-col items-center rounded-lg">
        ...
        <div className="flex flex-wrap p-9 md:p-5 lg:p-5 gap-2">
          <div
            className=" p-6 glass rounded-lg flex  w-[250px] md:w-[300px] lg:w-[350px] flex-col gap-2 items-center text-center"
            data-aos="zoom-in"
          >
            <h1 className="text-white mb-3 font-semibold text-xl">
              {firstPackage?.name}
            </h1>
            ...
            <p className="text-white ">
              <span className=" font-bold text-orange-500">Includes: </span>
              {firstPackage?.includes}
            </p>
            <p className="text-white ">
              <span className=" font-bold text-orange-500">
                Additional Options:{" "}
              </span>
              {firstPackage?.additional_options}
            </p>
            <button
              onClick={handleInterested}
              className=" mt-auto text-white rounded-lg bg-[#dd5549] px-2 py-2"
            >
              Interested
            </button>
          </div>
          ...
          >
            ...
            <p className="text-white ">
              <span className=" font-bold text-orange-500">Includes: </span>
              {secondPackage?.includes}
            </p>
            <p className="text-white ">
              <span className=" font-bold text-orange-500">
                Additional Options:{" "}
              </span>
              {secondPackage?.additional_options}
            </p>
            <button
              onClick={handleInterested}
              className="  mt-auto text-white rounded-lg bg-[#dd5549] px-2 py-2"
          ...
          >
            ...
            <p className="text-white ">
              <span className=" font-bold text-orange-500">Includes: </span>
              {thirdPackage?.includes}
            </p>
            <p className="text-white ">
              <span className=" font-bold text-orange-500">
                Additional Options:{" "}
              </span>
              {thirdPackage?.additional_options}
            </p>
            <button
              onClick={handleInterested}
              className="  mt-auto text-white rounded-lg bg-[#dd5549] px-2 py-2"
