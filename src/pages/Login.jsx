...
<div className=" h-screen max-h-full max-width-full w-screen bg-[url(https://i.ibb.co/r2m5nR9/bg-color.png)] bg-cover  p-1">
            ...
            <div className="mx-auto rounded-md mt-12 w-[570px] h-[450px] glass p-12">
        ...
        <form onSubmit={""} className="flex flex-col gap-4">
          <div>
            ...
            <input className=" glass rounded-sm w-full py-3 px-3" type="email" id="email" name="email" placeholder="Enter your email" />
          </div>
          <div>
            <h1 className=" mb-2 text-slate-200 font-semibold">Password</h1>
            <input className=" glass  rounded-sm w-full py-3 px-3" type="password" id="password" name="password" placeholder="Enter your password" />
          </div>
