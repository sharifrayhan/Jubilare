...
<div className=" h-screen max-h-full max-width-full w-screen bg-[url(https://i.ibb.co/r2m5nR9/bg-color.png)] bg-cover ">
        ...
        <hr className=" my-3" />
        <form onSubmit={(e) => handleLogin(e, navigate, location)} className="flex flex-col gap-4">
          <div>
      ...
      <center><button onClick={handleGoogleSignIn} className='mt-2 text-white text-sm flex mb-2 items-center gap-1 rounded-md px-12 py-2 w-[270px] border-[0.1px] border-white'><img className="w-5 ml-3 rounded-full avatar" src="https://i.ibb.co/wMJtbrm/google-icon.png" alt="" />Login with Google</button></center>
      </div>
        </div>
    );
};
