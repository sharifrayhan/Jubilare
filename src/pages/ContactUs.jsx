...
const AboutUs = () => {
    ...
    return (
        <div className=' bg-[url(https://i.ibb.co/tKq7M9F/bg-ab.jpg)] bg-cover'>
            <Navbar></Navbar>
            <center><h1 className='text-white  mt-3 font-bold text-2xl'>Contact Us</h1></center>
            <div className='mt-4 mb-5 pb-24 mx-auto'>
                ...
                <div className="mx-auto mt-2  mb-9  max-w-[1000px] max-h-[320px] glass p-12" >
                    <form className="flex flex-col gap-4" ref={getForm} onSubmit={handleSend}>
                        <input className=" glass placeholder-slate-800 w-full py-3 px-3" required type="text" id="name" name="name" placeholder='Your Name' />
                        <input className=" glass placeholder-slate-800 rounded-sm w-full py-3 px-3" required type="email" id="email" name="email" placeholder='Your Email' />
                        <textarea className='placeholder-slate-800 glass h-24 py-3 px-3' name="message" required placeholder='Write Your Message Here....' id="" cols="5" rows="10"></textarea>
                        <button className=" mx-auto glass rounded-md text-white w-24 py-3 bg-[#403F3F]"  type="submit">Send</button>
