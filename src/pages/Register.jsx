...
<div className="  max-h-auto   bg-[url(https://i.ibb.co/r2m5nR9/bg-color.png)] bg-cover p-1">
        ...
        <div>
            ...
            <input className=" glass w-full placeholder-slate-300 py-3 px-3" type="text" id="url" name="url" placeholder="Enter your photo url" />
          </div>
          <div>
            <h1 className=" mb-2 text-slate-200 font-semibold" >Email</h1>
            <input className=" glass w-full placeholder-slate-300 py-3 px-3" type="email" id="email" name="email" placeholder="Enter your email" />
          </div>
          <div>
            <h1 className=" mb-2 text-slate-200 font-semibold">Password</h1>
            <input className=" glass w-full placeholder-slate-300 py-3 px-3" type="password" id="password" name="password" placeholder="Enter your password" />
          </div>
